    ...
    >
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex gap-2 p-4">
                <a href="./edit.html?id=${id}" class="flex justify-center items-center bg-blue-500 rounded-full w-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                    </svg>
                </a>
                <button class="flex justify-center items-center bg-red-500 rounded-full w-8 h-8 delete-product-button" data-id="${id}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
